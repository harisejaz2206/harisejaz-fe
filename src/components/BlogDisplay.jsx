    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="flex justify-end">
          <button onClick={()=>{navigate("/blog-listing")}} className="text-gray-600 hover:text-gray-800 font-bold flex items-center">
          <span className="mt-4 mr-2 whitespace-nowrap">View All Blogs</span>
          </button>
        </div>
      </div>
    </div>
